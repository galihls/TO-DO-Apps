...
// Menentukan pesan default
var pesan = "Tidak ada perubahan data.";
...
document.addEventListener(SAVED_EVENT, function () {
  ...
  // Jika ada item dalam localStorage, ubah pesan
  if (item) {
    pesan = "Data telah berubah: " + item;
  }

  // Menampilkan pesan dalam alert
  alert(pesan);
  // Menampilkan toast menggunakan library toastr (harus sudah diinclude di halaman Anda)
